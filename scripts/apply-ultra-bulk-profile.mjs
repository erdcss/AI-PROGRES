...
const replacements = [
  ["const BULK_SCRAPE_RETRY_DELAY_MS = 2500;", "const BULK_SCRAPE_RETRY_DELAY_MS = 250;"],
  ["const BULK_SCRAPE_RETRY_DELAY_MS = 1200;", "const BULK_SCRAPE_RETRY_DELAY_MS = 250;"],
  ["const BULK_SCRAPE_RETRY_DELAY_MS = 600;", "const BULK_SCRAPE_RETRY_DELAY_MS = 250;"],
  ["const BULK_SCRAPE_CONCURRENCY_START = 1;", "const BULK_SCRAPE_CONCURRENCY_START = 5;"],
  ["const BULK_SCRAPE_CONCURRENCY_START = 2;", "const BULK_SCRAPE_CONCURRENCY_START = 5;"],
  ["const BULK_SCRAPE_CONCURRENCY_START = 3;", "const BULK_SCRAPE_CONCURRENCY_START = 5;"],
  ["const BULK_SCRAPE_CONCURRENCY_START = 6;", "const BULK_SCRAPE_CONCURRENCY_START = 5;"],
...
if (!src.includes("const BULK_SCRAPE_CONCURRENCY_START = 5;")) throw new Error("[ultra-bulk-profile] bulk scrape concurrency uygulanamadı");
if (!src.includes("const SHOPIFY_UPLOAD_CONCURRENCY = 3;")) throw new Error("[ultra-bulk-profile] upload concurrency uygulanamadı");
if (!src.includes("const BULK_SCRAPE_RETRY_DELAY_MS = 250;")) throw new Error("[ultra-bulk-profile] retry delay uygulanamadı");
fs.writeFileSync(target, src);
console.log("[ultra-bulk-profile] FAST bulk scrape concurrency=5, adaptive 429 fallback=1, upload concurrency=3, retry delay=250ms");
