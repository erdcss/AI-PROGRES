...
- July 11, 2025: Arçelik fetch hatası giderildi - API çağrısı parametre sırası düzeltildi (method, url, data), unhandled rejection hataları tamamen giderildi, sistem artık kararlı çalışıyor, 87 özellik + 8 görsel çıkarma başarımı, fiyat hesaplama sistemi aktif (53,802 TL → 61,872 TL)
