...
- July 11, 2025: Trendyol arayüzü basitleştirme tamamlandı - Karmaşık görsel galeri bölümü kaldırıldı, senaryo bilgileri görüntüleme alanı kaldırıldı, gereksiz teknik detaylar ve çoklu düğme seçenekleri temizlendi, sadece temel ürün özellikleri ve basit aksiyon düğmeleri ile kompakt arayüz tasarımı elde edildi, kullanıcı deneyimi sadeleştirme çalışması tamamlandı
- July 11, 2025: Akıllı ürün etiketleme sistemi optimize edildi - Gereksiz "trendyol-import", "auto-generated", "malzeme-", "renk-", "beden-" gibi jenerik etiket öncelleri kaldırıldı, sadece anlamlı ürün özellikleri (plastik, buz-kalıbı, mutfak, ev, 33-hazneli vb.) otomatik olarak üretiliyor, temiz ve öz etiketleme sistemi ile Shopify entegrasyonu geliştirildi
